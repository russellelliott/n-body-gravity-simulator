...
import { calculateOrbitalVelocity } from '../physics/nbodyEngine';
...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <div
      className={`relative z-30 transition-all duration-300 flex flex-col h-full bg-slate-950/85 backdrop-blur-xl border-l border-slate-800/80 text-slate-200 select-none ${
    ...
    >
      ...
      <button
        ...
        className="absolute -left-4 top-6 z-40 bg-slate-900 border border-slate-700/80 text-slate-300 hover:text-white p-1 rounded-full shadow-lg hover:scale-110 transition-transform"
              ...
              <div className="space-y-1.5 bg-slate-900/60 p-3 rounded-lg border border-slate-800">
                <div className="flex justify-between items-center">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const m = Math.max(0.01, parseFloat(e.target.value) || 0.1);
                      onUpdateBody({
                        ...selectedBody,
                        mass: m,
                        radius: Math.max(0.4, Math.pow(m, 0.33) * 0.6)
                      });
                    }}
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (item.type === 'black_hole') defaultMass = 2500;
              ...
              <div className="space-y-1.5 bg-slate-900/60 p-3 rounded-lg border border-slate-800">
                <div className="flex justify-between items-center">
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdateSpawnConfig({ mass: Math.max(0.01, parseFloat(e.target.value) || 0.1) })}
                    className="w-20 bg-slate-950 border border-slate-700 rounded px-2 py-0.5 text-right font-mono text-amber-400"
                  />
                </div>
                <input
